...
public abstract class GUI {
	...
	private static final String Restrictions_FILENAME = "restricyions.tab";
	...
	protected JComponent drawing; // we customise this to make it a drawing pane.
	...
	protected abstract void find_RoutePressed();
	...
	private void initialise() {
		...
		JToggleButton path = new JToggleButton("Find Route");
